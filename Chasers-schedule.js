...
After sprinting, 
base speed s will permanently be reduced by 1, 
and for the next one unit of time, 
the runner will enter recovery phase and can't sprint again.
...
Example:
  Given s = 2 and t = 4.
  We could schedule when runner should sprint 
  so we could get these possible sequences:
